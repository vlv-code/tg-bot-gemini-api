...
| `/q [текст]` | 🎭 **Режим Аватара:** чистый ответ от 1-го лица на реплай или черновик |
| `/personas` | 🎭 **Личности Аватара:** каталог стилей (Бро, Бизнес, Сарказм, Краткий, Флирт и свои) |
| `/prompts` | 🥊 **Промпты Stand:** каталог ролей (Кодер, Сисадмин, Переводчик, Аналитик и свои) |
| `/persona [имя/текст]` | 🎭 Выбрать личность или создать: `/persona add Имя = Текст` |
| `/prompt [текст]` | 🥊 Настроить Stand-промпт, выбрать пресет или создать: `/prompt add Имя = Текст` |
| `/qprompt [текст]` | 🎭 Настроить системный промпт для Режима Аватара (/q) |
