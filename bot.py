...
BOT_COMMANDS = [
    ...
    BotCommand(command="q", description="Режим Аватара: чистый ответ от 1-го лица"),
    BotCommand(command="personas", description="Личности Аватара (Бро, Бизнес, Сарказм...)"),
    BotCommand(command="prompts", description="Каталог промптов и ролей Stand-режима"),
    BotCommand(command="voice", description="Stand-режим: вопрос и ответ голосом"),
    BotCommand(command="text", description="Stand-режим: вопрос и ответ текстом"),
    ...
    BotCommand(command="prompt", description="Настроить промпт для Stand-режима"),
    BotCommand(command="qprompt", description="Настроить промпт для Режима Аватара (/q)"),
