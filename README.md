...
- Обращение к боту из любого чата:
  - `@bot_username ваш вопрос` — Stand-режим с цитированием запроса.
  - `@bot_username /q ваши указания` — Режим Аватара (чистый ответ от 1-го лица).
  - `@bot_username /tts текст` — мгновенное голосовое сообщение из кэша.
